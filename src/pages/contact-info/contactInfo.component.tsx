...
import mg from './contactInfo.messages'
import smg from '~/i18n/messages/pages'
import useStyle from './contactInfo.style'
...
const ContactInfo: FC = () => {
  ...
  return (
    <>
      <SEO title={formatMessage(smg['title.contact-info'])} />

      <Box mb={4}>
        <Box className={classes.banner}>
          <Banner title="Contact Info" imgSrc={baner}>
