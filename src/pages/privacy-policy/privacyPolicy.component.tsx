...
import mg from './privacyPolicy.messages'
import smg from '~/i18n/messages/pages'
import useStyle from './privacyPolicy.style'
...
const PrivacyPolicy: FC = () => {
  ...
  return (
    <>
      <SEO title={formatMessage(smg['title.privacy-policy'])} />

      <Box mb={4}>
        <Box className={classes.banner}>
          <Banner title="PrivacyPolicy" imgSrc={baner}>
